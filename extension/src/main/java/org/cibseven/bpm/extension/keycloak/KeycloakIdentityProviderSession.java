...
import org.cibseven.bpm.extension.keycloak.cache.QueryCache;
...
public class KeycloakIdentityProviderSession implements ReadOnlyIdentityProvider {
	...
	public User findUserById(String userId) {
		return createUserQuery(org.cibseven.bpm.engine.impl.context.Context.getCommandContext()).userId(userId)
				.singleResult();
	}
	...
	public UserQuery createUserQuery() {
		return new KeycloakUserQuery(org.cibseven.bpm.engine.impl.context.Context.getProcessEngineConfiguration()
	...
	public Group findGroupById(String groupId) {
		return createGroupQuery(org.cibseven.bpm.engine.impl.context.Context.getCommandContext()).groupId(groupId)
				.singleResult();
	}
	...
	public GroupQuery createGroupQuery() {
		return new KeycloakGroupQuery(org.cibseven.bpm.engine.impl.context.Context.getProcessEngineConfiguration()
				.getCommandExecutorTxRequired());
	}
	...
	public TenantQuery createTenantQuery() {
		return new KeycloakTenantQuery(org.cibseven.bpm.engine.impl.context.Context.getProcessEngineConfiguration()
				.getCommandExecutorTxRequired());
	}
