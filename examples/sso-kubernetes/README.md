...
The handler itself (see ``sso.showcase.org.cibseven.bpm.extension.keycloak.KeycloakLogoutHandler``) takes care of sending an appropriate redirect to Keycloak. The redirect URI will look similar to
