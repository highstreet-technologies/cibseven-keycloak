...
public class WebAppSecurityConfig {
    ...
    public FilterRegistrationBean containerBasedAuthenticationFilter() {
        ...
        filterRegistration.setInitParameters(Collections.singletonMap("authentication-provider", "auth.org.cibseven.bpm.extension.keycloak.KeycloakJwtAuthenticationProvider"));
